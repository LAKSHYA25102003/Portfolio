...
const WhatIDo = () => {
    return (
        <div className='w-[80%] flex flex-col justify-center  mx-auto'>
            ...
            <div className='flex justify-center items-center gap-[100px] py-[40px] '>
                <div className=' h-[200px] flex flex-col bg-[#ff4D41] px-[20px] py-[20px] rounded-md w-[300px]'>
                ...
                <div className='flex flex-col h-[200px] bg-[#ff4D41] px-[20px] py-[20px] rounded-md w-[300px]'>
                    <div className='flex gap-4 items-center'>
